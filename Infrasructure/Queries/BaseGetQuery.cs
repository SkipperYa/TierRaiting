...
{
	public class BaseGetQuery<TQuery, TEntity, TResult> : BaseAuthorizeHandler<TQuery, TResult>
		...
		where TEntity : WithId, IWithUserId
	{
		...
		public BaseGetQuery(ApplicationContext applicationContext, IMapper mapper)
		{
